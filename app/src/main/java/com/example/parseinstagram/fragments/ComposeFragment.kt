...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPreview = view.findViewById(R.id.iv_photo)
        view.findViewById<Button>(R.id.btn_submit).setOnClickListener{
            ...
            if(photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "Error taking photo")
                Toast.makeText(requireContext(), "Error capturing photo", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    fun submitPost(description: String, user: ParseUser, file : File){
        ...
        post.saveInBackground { exception ->
            if(exception != null){
                ...
                requireView().findViewById<EditText>(R.id.et_description).text.clear()
